# Generated by Django 5.1 on 2024-09-16 22:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text="Enter the book's natural language (eg: English, French, Japanese etc.)", max_length=200, unique=True)),
            ],
            options={
